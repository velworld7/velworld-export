...
const WhatsAppButton: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[100] group">
      {/* Tooltip */}
      <div className="absolute right-full mr-4 top-1/2 -translate-y-1/2 px-4 py-2 bg-white/90 backdrop-blur-md border border-black/5 rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition-all duration-500 translate-x-4 group-hover:translate-x-0 pointer-events-none whitespace-nowrap">
        <span className="text-[10px] font-black tracking-[0.2em] text-[#1d1d1f] uppercase">Chat with us</span>
      </div>
