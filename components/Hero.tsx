      ...
      */}
      ...
      <div className="relative z-20 w-full max-w-[95rem] px-6 mx-auto flex flex-col items-center">
        <div className="text-center opacity-0 animate-apple-in" style={{ animationDelay: '0.4s' }}>
          <h1
            className="text-[12vw] md:text-[8vw] lg:text-[8rem] font-bebas leading-[0.9] tracking-tight text-white uppercase mb-4 vel-world-title drop-shadow-2xl"
          >
            VEL WORLD
          </h1>
          <h2 className="text-[3.5vw] md:text-[2vw] lg:text-[1.5rem] font-bebas tracking-[0.3em] text-white/90 uppercase max-w-4xl mx-auto drop-shadow-lg">
